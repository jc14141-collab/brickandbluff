...
export function renderRoomSkills(view,r){
 ...
 let can=!s.used&&!g.done&&(poker?g.turn===r.you&&!own.fold&&!g.runout&&(role===2||g.street===0):role===3?g.phase==='bets':role===2?!!own.bet&&g.phase!=='bets':g.phase==='players'&&g.turn===r.you&&!own.done);
